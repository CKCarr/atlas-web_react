...
// Define the schemas for testing
...
describe("Normalized Data Tests", () => {
  it("should return correct result array", () => {
    const expectedResult = [
  ...
  it("should return correct user entity", () => {
    const expectedUser = {
      age: 25,
  ...
  it("should return correct message entity", () => {
  ...
  it("should return correct notification entity", () => {
